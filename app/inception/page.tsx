...
export default function InceptionSwarms() {
    return (
        <main className="container view">
            <BackgroundBlur />
            <div className="h-80 flex flex-col items-center justify-center gap-3">
                <h2 className="text-center">Inception <span className="font-bold">Swarms</span></h2>
                <div className="text-muted flex flex-row flex-wrap text-lg items-center justify-center">
                    ...
                    <p className="text-center text-nowrap">&ensp;tokens into our inception swarms.</p>
                </div>
            </div>
            <SwarmsPreviewGrid filterType="inception" />
        </main>
    )
}

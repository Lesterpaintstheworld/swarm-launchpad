    ...
    return (
        <div className="w-[100vw] h-fit flex flex-row metallic-bg-ubc py-2 text-sm">
            <div className="container mx-auto flex flex-row justify-between items-center gap-6 flex-wrap">
                <p className="text-background font-semibold">Secondary <Link href={'/marketplace?tab=listings'} className="underline">market</Link> is now live! Buy and sell shares through P2P trading.</p>

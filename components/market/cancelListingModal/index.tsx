                        ...
                        {isFetching ?
                            ...
                            <span>
                                {tokenPrices && tokenPrices.get(token.mint === '11111111111111111111111111111111' ? '11111111111111111111111111111111' : token.mint) ?
                                    IntlNumberFormatCurrency((((Number(listing.pricePerShare) / (token?.resolution || 1_000_000)) * Number(listing.numberOfShares)) * 1.05) * tokenPrices.get(token.mint === '11111111111111111111111111111111' ? '11111111111111111111111111111111' : token.mint)!)
                                    :
                                    'No dex data'
                                }
                            </span>

...
export function Navigation() {
  ...
  return (
    <nav className="container w-full py-8 flex flex-row">
		...
		<NavigationMenu className="ml-6 mr-auto">
						...
						<ul className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
							<li className="row-span-3">
								<NavigationMenuLink asChild>
									<a
										className="flex h-full w-full select-none flex-col justify-end transition-colors rounded-md bg-gradient-to-b from-muted/50 to-muted p-6 no-underline outline-none focus:shadow-md hover:bg-foreground/5"
							...
							<ListItem href="/docs" title="165 Day Pool" className="flex flex-row flex-wrap">
								For those looking for a more long term investment. 
							</ListItem>
							<ListItem href="/docs/installation" title="90 Day Pool">
								Our most popular pool with over 55M UBC staked. 
							</ListItem>
							<ListItem href="/docs/primitives/typography" title="30 Day pool">
    ...
    <li>
      <NavigationMenuLink asChild>
        <a
          ref={ref}
          className={cn(
            "block select-none space-y-1 gap-2 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-foreground/5 hover:text-accent-foreground focus:bg-foreground/5 focus:text-accent-foreground",
            className
          )}
          {...props}
        >

    ...
    <div className="group relative w-full rounded-xl bg-gradient-to-r from-white/5 via-white/[0.07] to-white/5 border border-white/10 hover:border-white/20 transition-all duration-500 overflow-hidden">
      <div className="relative p-5">
        ...
        <div className="flex flex-col gap-4">
          {/* Main Row with Swarms and Connection Line */}
          <div className="flex items-center justify-between">
            ...
            <div className="flex-1 mx-4 flex flex-col items-center">
              <div className={`px-4 py-1.5 rounded-full text-xs border ${statusStyles[status]} backdrop-blur-sm transition-all duration-300 group-hover:scale-110 relative mb-2`}>

...
Join the arbitrage revolution with PropertyKin.`,
    ...
    },
    {
        ...
        gallery: [
            { type: 'image', content: '/swarms/robinhood/1_Robinhood-Agent-Level-the-Playing-Field.png' },
            { type: 'image', content: '/swarms/robinhood/2_The-Future-of-Trading-AI-Driven-and-Ethical.png' },
            { type: 'image', content: '/swarms/robinhood/3_A-Ground-Floor-Opportunity.png' },
            { type: 'image', content: '/swarms/robinhood/4_Inception-Swarm-Invest-in-the-Future.png' },
            { type: 'image', content: '/swarms/robinhood/5_Join-Us-in-the-Revolution.png' },
            { type: 'image', content: '/swarms/robinhood/6_The-Future-of-Trading-is-Here.png' }
        ],
